...
plt.xlim(-1,2.5)
#plt.ylim(0,1.6)
plt.savefig('hist2d_XR_vs_R101.pdf',dpi=800)
plt.show()
...
plt.xlim(-0.75,0.15)
plt.ylim(-1.3,0.2)
plt.savefig('hist2d_ratio1_ratio2.pdf',dpi=800)
plt.show()
...
plt.xlim(0,2.5)
plt.ylim(-1.3,0.2)
plt.savefig('hist2d_R51_ratio2.pdf',dpi=800)
plt.show()
...
plt.xlim(-0.25,2.25)
plt.ylim(-1.8,0.1)
plt.savefig('hist2d_R151_peakval.pdf',dpi=800)
plt.show()

plt.figure(figsize=(8,8))
plt.hist2d(dr14_R151,dr14_ratio1,bins=(50,50), norm=clrs.LogNorm(),cmap=plt.cm.BuPu)
plt.colorbar()
...
plt.xlim(-0.1,2)
plt.ylim(-0.9,0.1)
plt.savefig('hist2d_R101_ratio1.pdf',dpi=800)
plt.show()
