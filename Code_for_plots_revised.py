...
inputFile = 'DR14_StatsCatalog.csv'
outputFile = 'DR14_SmallR_LargeXR.csv'
...
t1 = time.time()
print('time for this task: '+str( (t1-t0)/3600.)+' hours')
print('projecting time remaining: '+str( 5*(t1-t0)/3600. ) + ' hours')
print('FINDING MIN R 101')

r101 = matches(R101,apogeeid,locationid,0,peak_value)
dr14_R101= np.asarray(r101[0])
t2 = time.time()
print('time for this task: '+str((t2-t1)/3600.)+' hours')
print('projecting time remaining: '+str( 1.5*(t2-t0)/3600. ) + ' hours')
print('FINDING MIN R 151')

r151 = matches(R151,apogeeid,locationid,0,peak_value)
dr14_R151 = np.asarray(r151[0])
t3 = time.time()
print('time for this task: '+str((t3-t2)/3600.)+' hours')
print('projecting time remaining: '+str( 0.66*(t3-t0)/3600. ) + ' hours')
print('FINDING MIN R151/R101')

ratio_1 = matches(ratio1,apogeeid,locationid,0,peak_value)
dr14_R1 = np.asarray(ratio_1[0])
t4 = time.time()
print('time for this task: '+str((t4-t3)/3600.)+' hours')
print('projecting time remaining: '+str( 0.2*(t4-t0)/3600. ) + ' hours')
