...
def twod_hist(x,y,a,b,title,xlabel,ylabel):
    ...
    ylabel = str(ylabel)
    plt.figure(figsize=(8,8))
    plt.hist2d(x,y,bins=(500,500),normed=True,cmap=plt.cm.PuBu)
...
df.to_csv('Updated_DR14_SmallR_LargeXR.csv')
...
# #Generate a graph for xrange vs R_101
# xr_vs_r101 = twod_hist(dr14_xr,dr14_r101,tsb_xr,tsb_r101,'X ranges vs R_101','log(max x-range)','log($R_{101}$)')

# #Generate a graph for max x-range vs R_101/R_51 (Ratio 2)
# xr_vs_R2 = twod_hist(dr14_xr,dr14_ratio2,tsb_xr,tsb_ratio2,'X ranges vs R101_R51','log(max x-range)','log($R_{101}/R_{51}$)')

# #Generate a graph for max x-range vs R_151/R_101 (Ratio 1)
# xr_vs_R1 = twod_hist(dr14_xr,dr14_ratio1,tsb_xr,tsb_ratio1,'X ranges vs R151_R101','log(max x-range)','log($R_{151}/R_{101}$)')